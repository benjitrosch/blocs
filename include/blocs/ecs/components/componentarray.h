...
namespace blocs
{
	namespace ecs
	{
		...
		struct ComponentArray : public IComponentArray
		{
			...
			/**
			 * @brief Adds a component to the next available index in the packed array.
			 * Then creates two maps between entity and array index.
			 * 
			...
			/**
			 * @brief Removes an entity and updates the maps to keep array data packed.
			 * 
			 ...
			 * 
			 * @return Reference to the component belonging to the specified entity.
			 */
			T& get(Entity entity)
			{
				return components[set.value(entity)];
