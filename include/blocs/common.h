...
#define UNDL(x) "\x1B[4m" << x << "\x1B[0m"
	...
	#define LOG_DEBUG(msg) do { std::cout\
		<< msg << "\n";\
	} while (0)

	#define LOG_INFO(msg) do { std::cout\
		<< CYN("[" << __FILENAME__ << ", " << __LINE__ << "]: "\
		<< msg) << "\n";\
	} while (0)

	#define LOG_GOOD(msg) do { std::cout\
		<< GRN("[" << __FILENAME__ << ", " << __LINE__ << "]: "\
		<< msg) << "\n";\
	} while (0)

	#define LOG_WARN(msg) do { std::cout\
		<< YEL("[" << __FILENAME__ << ", " << __LINE__ << "]: "\
		<< msg) << "\n";\
	} while (0)

	#define LOG_ERR(msg) do { std::cerr\
		<< RED("[" << __FILENAME__ << ", " << __LINE__ << "]: "\
		<< msg) << "\n";\
	} while (0)
#else
	#define LOG_DEBUG(msg) do { } while (0)
	#define LOG_INFO(msg)  do { } while (0)
	#define LOG_GOOD(msg)  do { } while (0)
